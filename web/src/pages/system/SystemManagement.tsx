...
import { Flex, GetRef, message, Spin } from 'antd';
...
import locale from '@/test/mocks/demo/_utils/local';
                ...
                <div className={styles.layout}>
                    ...
                    <div className={styles.chat}>
                        <div className={styles.chatList}>
                            ...
                            >
                                {messages.length === 0 && (
                                    <div className={styles.agentName}>System Management Assistant</div>
                                )}
                                <Sender
                                    suffix={false}
                                    ref={senderRef}
